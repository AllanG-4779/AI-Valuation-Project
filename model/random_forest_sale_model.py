...
with open("models/sale_model.pkl", "wb") as file:
    pickle.dump(model, file)

print("\nSale model saved successfully!")

with open("models/sale_encoders.pkl", "wb") as file:
    pickle.dump(encoders, file)

print("Sale encoders saved successfully!")

# Save feature names for inference
with open("models/sale_features.pkl", "wb") as file:
